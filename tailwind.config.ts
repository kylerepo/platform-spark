  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "hero-pattern": "linear-gradient(135deg, hsl(222 47% 5% / 0.95) 0%, hsl(222 47% 8% / 0.8) 50%, hsl(186 100% 30% / 0.1) 100%)",
      },
      boxShadow: {
        ...
        "card": "0 4px 20px hsl(0 0% 0% / 0.2)",
        "card-hover": "0 8px 40px hsl(var(--primary) / 0.15)",
      },
    },
  },
